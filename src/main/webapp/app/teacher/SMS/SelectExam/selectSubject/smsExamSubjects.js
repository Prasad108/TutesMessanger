(function(){
	...
	var app=angular.module("myApp");
	  ...
	  app.controller('smsExamSubjectCtrl',smsExamSubjectCtrl)
	  
		   
		smsExamSubjectCtrl.$inject=['shairedDataService','$stateParams','$scope','$http','InstTreeStructureWithSubject'];
	   function smsExamSubjectCtrl( shairedDataService, $stateParams,$scope, $http,InstTreeStructureWithSubject) {	  
