...
angular.module("myApp").controller("ResultsExamsController",ResultsExamsController);
ResultsExamsController.$inject=['$scope','$http','$interval','$filter','ivhTreeviewMgr','shairedDataService'];


function ResultsExamsController($scope, $http, $interval, $filter,ivhTreeviewMgr,shairedDataService){
	
	console.log("*******ResultsExamsController*********");
