                          ...
                          <div class="panel panel-success">
                              ...
                              <div id="collapseTwo" class="panel-collapse collapse">
                                  <div class="panel-body">
                                      ...
                                      <section class="panel">
                         				 	<div class="panel-body">
                            				  <form class="form-horizontal " id="SelectBranch" method="post">
	                            					 <label class="control-label col-lg-2" for="inputSuccess">Select Branch to which class is to be added</label>
	                                     		 	 <select class="form-control input-lg m-bot15" form="SelectBranch">
