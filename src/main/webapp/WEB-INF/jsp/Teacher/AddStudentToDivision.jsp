  ...
  <section id="main-content">
          <section class="wrapper">  
          		  ...
          		  <div class="panel-body" ng-show="studentList.length">
		                              <form class="form-horizontal " method="get"  > 
		                                     <div class="form-group" >
		                                      ...
		                                      <div class="col-lg-10">
		                                          ...
		                                          <div class="col-lg-2">   <!-- data-toggle="modal" href="#myModal"  -->
		                                               <button class="btn btn-primary"  id="aStudentSubmitBTN" type="submit" ng-click="showModal()">Add Selected Students to Division</button>
		                                               <!-- Modal -->
																					...
																					<form name="SelectDivisionForm" class="form-validate form-horizontal " id="SelectDivisionToShowStudents" >
																						...
																						<div class="form-group">
														                                          <div class="col-lg-offset-2 col-lg-10">
														                                              <button  ng-disabled="SelectErrorMessage" class="btn btn-primary" data-dismiss="modal" ng-click="AddSelectedStudentToDivision()" id="showStudentSubmitBTN" type="submit">Add Selected Students To Division</button>
														                     					 </div>
														                                </div>
																					</form>
          		   ...
          		   <div class="panel-body"  ng-show="studentList.length">
				                      <table id="example" class="table  " ng-show="studentList.length">
				                       <tbody>
				                          
				                              <tr>
												<th ><label ng-show="ShowSelectAll">
							                       <input type="checkbox" ng-model="IsAllChecked" ng-change="CheckUncheckAll();checkNoneSelected();disableSuccessMessage()" /> Select All</label>
							                       <label ng-show="!ShowSelectAll">
							                       <input type="checkbox" ng-model="IsFilteredAllChecked" ng-change="filterCheckUncheckAll();checkNoneSelected();disableSuccessMessage()" /> Select Filtered All</label>
							                    </th>
				                              ...
				                              <tr ng-repeat="student in filteredTodos | filter : student_filter" ng-class="{selectedrow:student.Selected}"  >
													...
													<td><input  type="checkbox" ng-model="student.Selected" ng-change="CheckUncheckHeader();filteredCheckUncheckHeader();checkNoneSelected();disableSuccessMessage()" /></td>
