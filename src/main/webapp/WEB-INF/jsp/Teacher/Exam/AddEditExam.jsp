					                              ...
					                              <form class="form-horizontal "  name="SelectExamForm"  method="get">
					                                  <div class="form-group">
					                                      ...
					                                      <div class="col-lg-10">
					                                          ...
					                                          <select class="form-control input-lg m-bot15"  ng-model="selectedExamForAddSubject" ng-options="exam.discription for (x,exam) in examList"   ng-change="ExamChanged();ShowTree()" required="required" required="required" required></select>
										...
										<section class="panel">
				                          <div class="panel-body">	
				                        	...
				                        	<div id="ShowTreeStrct" ng-show="ShowTreeStruct" >													
													...
													<div class="alert alert-warning fade in" ng-show="!selectedSubject.length">
	                                  			...
	                                  			<table class="table">
	                                  				<tr>
	                                  					...
	                                  					<tr ng-repeat="subject in selectedSubject" >
	                                  							...
	                                  							<td> 
																      <div class="form-group ">
									                                      <input type="number" ng-model="subject.OutOF" ng-change="subject.KeepSameOutOF && KeepSameOutOFFunction()" class="form-control" id="exampleInputEmail2" placeholder="Out Of Marks" required="required">
									                                    	<div ng-if="$index==0"><input ng-model="subject.KeepSameOutOF" ng-change="subject.KeepSameOutOF && KeepSameOutOFFunction()"  class="checkbox-inline" type="checkbox" id="inlineCheckbox1" value="option1"><!-- //--KSA  Keep same for ALL-->
									                                    		 Keep same for all
									                                    	</div>
									                             ...
									                             <td>
									                                  <div class="form-group">
									                                      <input type="number" ng-model="subject.PassingMarks" ng-change="subject.KeepSamePassingMarks && KeepSamePassingMarksFunction()" class="form-control" ng-class="{error : subject.PassingMarks>subject.OutOF }"  attrs="{data-tip= ' Passing are greater than Out Of Marks ': subject.PassingMarks>subject.OutOF }" id="exampleInputPassword2" placeholder="Passing Marks" required="required">
									                                      <div ng-if="$index==0"><input ng-model="subject.KeepSamePassingMarks" ng-change="subject.KeepSamePassingMarks && KeepSamePassingMarksFunction()"  class="checkbox-inline" type="checkbox" id="inlineCheckbox1" value="option1">
									                                    		 Keep same for all
									                                    	</div>
									                                  </div>
									                              </td>
									                              <td>
									                                  <div class="form-group">
									                                      <input type="number" ng-model="subject.DurationInMinutes" ng-change="subject.KeepSameDurationInMinutes && KeepSameDurationInMinutesFunction()" class="form-control" id="exampleInputPassword2" placeholder="Duration in Minutes" required="required">
									                                      <div ng-if="$index==0"><input ng-model="subject.KeepSameDurationInMinutes" ng-change="subject.KeepSameDurationInMinutes && KeepSameDurationInMinutesFunction()" class="checkbox-inline" type="checkbox" id="inlineCheckbox1" value="option1">
									                                    		 Keep same for all
									                                    	</div>
									                                  </div>
																 </td>
																  <td>
									                                  <div class="form-group">
									                                      <input type="text" ng-model="subject.ExamDate"  ng-change="subject.KeepSameExamDate && KeepSameExamDateFucntion()" class="form-control datepicker" id="datepicker-topleft-forreal" placeholder="Date" required="required" >
									                                      <div ng-if="$index==0"><input ng-model="subject.KeepSameExamDate" ng-change="subject.KeepSameExamDate && KeepSameExamDateFucntion()"  class="checkbox-inline" type="checkbox" id="inlineCheckbox1" value="option1">
									                                    		 Keep same for all 
									                                    	</div>
									                                  </div>
																 </td>
