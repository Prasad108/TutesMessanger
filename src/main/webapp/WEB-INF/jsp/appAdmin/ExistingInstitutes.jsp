...
<html ng-app="adminApp" ng-controller="adminCntrl">
<head>
...
app.controller('adminCntrl',function($http,$scope)
		{
		
		$scope.instituteList=JSON.parse('${instituteListInJSON}'); 
	    console.log($scope.instituteList);
	    
	  //------------------------------Load Selected Institute containts in Modal Form-----------------------------------------------------------------------	   		
		$scope.LoadEditInstitute = function(institute) {
			...
			$scope.nameEditInstitute =institute.name;
			$scope.addressEditInstitute = institute.address;
			$scope.contactEditInstitute = institute.contactno;
			$scope.emailEditInstitute = institute.email;
			$scope.idEditInstitute = institute.id;
			$scope.subscriptionEditInstitute=institute.subscriptionTill;
			...
			console.log($scope.subscriptionTill); 

		};

		
		$scope.UpdateInstituteFunction =function ()
		{
			var updateInstituteVAR={};
					
				updateInstituteVAR.id= $scope.idEditInstitute;
				updateInstituteVAR.name= $scope.nameEditInstitute;
				updateInstituteVAR.contactno= $scope.contactEditInstitute;
				updateInstituteVAR.address= $scope.addressEditInstitute;
				updateInstituteVAR.email= $scope.emailEditInstitute;
				updateInstituteVAR.subscriptionTill=new Date($scope.subscriptionEditInstitute);
				
				console.log("hi");
				console.log(updateInstituteVAR);
				
				var data = JSON.stringify(updateInstituteVAR);
			         ...
			         function(response)
			         {
			        	// if success       	
							...
							console.log(response.data);
							 ...
							 for (i = 0; i<$scope.instituteList.length; i++)
							{
								if ($scope.instituteList[i].id == updateInstituteVAR.id)
									$scope.instituteList.splice(i,1);// remove the updating institute 				  		   	   
					        } 
							$scope.instituteList.push(response.data);// add new modfied exam

							//$scope.instituteUpdateSuccess = true;

					},
						function(data)
                        { // optional
							// failed		                 
							console.log(" failed to save the institute");
						});
...
<body>
  ...
  <section id="main-content">
		  ...
		  <div id="ExistingInstitute" class="tab-pane active">
      								   <div class="row">
								                  <div class="col-lg-12">
								                      <section class="panel">
							                              ...
							                              <div class="alert alert-info fade in" ng-show="InstituteUpdateSuccess">
							                                  <button data-dismiss="alert" class="close close-sm" type="button">
							                                      <i class="icon-remove"></i>
							                                  </button>
							                                  <strong>Institute Updated Successfully</strong> 
							                              </div>
								                          ...
								                          <div class="table-responsive">
								                            <table class="table">
								                              ...
								                              <tbody>
								                                <tr ng-repeat="institute in instituteList | orderBy:'id'">
								                                  <td>{{institute.id}}</td>
								                                  <td>{{institute.name}}</td>                                  
								                                  <td>{{institute.email}}</td>
								                                  <td>{{institute.contactno}}</td>
								                                  <td>{{institute.address}}</td>
								                                  <td>{{institute.subscriptionTill}}</td>
								                               	  <td>	
								                               	 	 <a class="btn btn-primary"  data-toggle="modal" ng-click="LoadEditInstitute(institute)" href="#myModal" ><i  class="icon_plus_alt2"  ></i></a>     	
											                                          ...
											                                          <div class="modal-body">
											                                               ...
											                                               <form class="form-horizontal " name="EditInstituteForm" method="get">
																                                   ...
																                                   <div class="form-group">
																                                      ...
																                                      <div class="col-sm-10">
																                                          <input ng-model="idEditInstitute" type="text" class="form-control" required="required" readonly="readonly">
																                                      </div> 
																                                  </div>
																                                  ...
																                                  <div class="form-group">
																                                      ...
																                                      <div class="col-sm-10">
																                                          <input ng-model="$parent.nameEditInstitute" type="text" class="form-control" required="required">
																                                      </div>
																                                   ...
																                                   <div class="form-group">
																                                      ...
																                                      <div class="col-sm-10">
																                                          <input ng-model="$parent.addressEditInstitute" type="text" class="form-control" required="required">
																                                      </div>
																                                  </div>
																                                   <div class="form-group">
																                                      <label class="col-sm-2 control-label">Contact Number<span class="required">*</span></label>
																                                      <div class="col-sm-10">
																                                          <input ng-model="$parent.contactEditInstitute" type="text" class="form-control" required="required">
																                                      </div>
																                                  </div>
																                                  <div class="form-group">
																	                                   <div class="form-group">
																	                                      ...
																	                                      <div class="col-sm-10">
																	                                         <input ng-model="$parent.emailEditInstitute" type="text" class="form-control" required="required">
																                                  ...
																                                  <div class="form-group">
																	                                   <div class="form-group">
																	                                      ...
																	                                      <div class="col-sm-10">
																	                                            <input ng-model="$parent.subscriptionEditInstitute" type="text" class="form-control" required="required">
																	                                      </div>
																	                                  </div>
																                                  </div>
																                                    ...
																                                    <div class="form-group">
																                                      <div class="col-lg-offset-2 col-lg-10">
																                                          <button type="submit" data-dismiss="modal" class="btn btn-primary" ng-click="UpdateInstituteFunction()" ng-disabled=" !EditInstituteForm.$valid || !EditInstituteForm.$dirty">Update Institute</button>
																                                      </div>
																                                  </div>
